...
@Component
public class S3AlbumCapaStorage implements AlbumCapaStorage{

    private final S3Client s3Client;
    private final S3Presigner presigner;
    private final MinioProperties minioProperties;

    public S3AlbumCapaStorage(S3Client s3Client, S3Presigner presigner, MinioProperties minioProperties) {
